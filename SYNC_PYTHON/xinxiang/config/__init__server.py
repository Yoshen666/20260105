...
g_debug_file_path = "d:\\debug"
g_debug_file = g_debug_file_path + "\\debug.db"
g_print_flag = True
...
g_postgres_host = '10.52.192.99'
g_postgres_database = 'dev_uo'
g_postgres_port = '5432'
g_postgres_user = 'xxetl'
g_postgres_password = 'xxetl1234'
# 共享的Postgres路径(最终在pg server中的路径也为{g_mem_etl_output_path}/时间戳.csv )
g_pgserver_path = '\\\\10.52.192.99\\ETLOutput'

g_test_postgres_host = '10.52.192.99'
g_test_postgres_database = 'uo'
g_test_postgres_port = '5433'
...
g_mem_oracle_dat_input_path = 'D:\workspace\ArchiveFile'
# Oracle sqldr配置文件路径
g_mem_oracle_sqldr_config_path = 'D:\workspace\ExportConfig'
# sync 产出路径
g_mem_sync_result_path = 'D:\workspace\SrcData'
# sync duckdb > dat 产出路径
g_mem_sync_dat_output_path = 'D:\workspace\ExportData'
# ETL 产出路径
g_mem_etl_output_path = 'D:\workspace\ETLOutput'
# 内存的硬盤化
g_mem_speed_etl_output_path = 'G:\workspace'
