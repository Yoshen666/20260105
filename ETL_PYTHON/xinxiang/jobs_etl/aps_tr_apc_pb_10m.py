...
#     sql = """
#         INSERT  /*+ append */  INTO APS_TR_APC_PB(
#                 PRODSPEC_ID, PR_OP_NO, PR_UNIT_ID, PB_FLAG, PB_COMMENT,FOURTH_VAL_FLG,
#                 PB_UPD_DATE,JOB_NO, MAX_EFEC_DAY, PIRUN_EFEC_DAY, UPDATE_TIME,
#                 REMAIN_DAY,MASK, GUID, PARTKEY
#          )
#          SELECT PB.PRODSPEC_ID, PB.PR_OP_NO, PB.PR_UNIT_ID, PB.PB_FLAG, PB.PB_COMMENT,PB.FOURTH_VAL_FLG,
#                 PB.PB_UPD_DATE,PB.JOB_NO, PB.MAX_EFEC_DAY, PB.PIRUN_EFEC_DAY, PB.UPDATE_TIME,
#                 PB.REMAIN_DAY,PB.MASK, '{uuid}' AS GUID,
...
#                      methodName="Insert Into APS_TR_APC_PB",
#                      sql=sql,
#                      current_time=current_time,
#                      update_table="APS_TR_APC_PB")
#
#
# def execute():
#     ###############################################################
...
#     ###############################################################
#     ETL_Proc_Name = "APS_ETL_BR.APS_TR_APC_PB_10M"
#     current_time = my_date.date_time_second_str()
#     current_time_short = my_date.date_time_second_short_str()
#     uuid = my_oracle.UUID()
#
#     target_table = "APS_TR_APC_PB"
#     used_table_list = ['APS_SYNC_SCHE_APC_PB']
#     target_table_sql = """
#     create table {}APS_TR_APC_PB
#     (
#         prodspec_id    VARCHAR(30) not null,
#         pr_op_no       VARCHAR(10) not null,
#         pr_unit_id     VARCHAR(10) not null,
#         pb_flag        VARCHAR(1),
#         pb_comment     VARCHAR(256),
#         fourth_val_flg VARCHAR(2),
#         pb_upd_date    VARCHAR(64),
#         job_no         VARCHAR(64),
#         max_efec_day   VARCHAR(64),
#         pirun_efec_day VARCHAR(64),
#         update_time    VARCHAR(64),
#         remain_day     VARCHAR(64),
