...
#     sql = """
#     INSERT  /*+ append */  INTO APSTMP_TR_TYPE25 (
#         GUID, TOOLG_ID, TOOL_ID, PPID, PROCESS_START, PROCESS_END, QTY
#     )
#      WITH TOOLG AS (
...
#          LEFT JOIN TOOLG TL
#          ON TL.EQP_ID = F.eqp_id
#          WHERE F.OPE_CATEGORY ='ScannerEnd'
...
#          WHERE OPE_CATEGORY ='ScannerStart'
#          AND CLAIM_TIME >= DATE_TRUNC('day', CURRENT_DATE) - INTERVAL '60 day'
#      )
#      SELECT gen_random_uuid() AS GUID,
#             LE.TOOLG_ID,
#             LE.EQP_ID AS TOOL_ID,
#             LE.PH_RECIPE_ID AS PPID,
#             -- TO_CHAR(LS.CLAIM_TIME,'YYYY-MM-DD HH24:MI:SS') AS PROCESS_START,
#             STRFTIME(LS.CLAIM_TIME, '%Y-%m-%d %H:%M:%S') AS PROCESS_START,
#             -- TO_CHAR(LE.CLAIM_TIME,'YYYY-MM-DD HH24:MI:SS') AS PROCESS_END,
#             STRFTIME(LE.CLAIM_TIME, '%Y-%m-%d %H:%M:%S') AS PROCESS_END,
#             LE.ORG_WAFER_QTY AS QTY
#       FROM SCANNEREND LE, SCANNERSTART LS
#       WHERE 1=1
#       AND LE.LOT_ID = LS.LOT_ID
#       AND LE.CTRL_JOB = LS.CTRL_JOB
#     """.format()
#
#     my_duck.exec_sql(oracle_conn=oracle_conn,
#                      duck_db_memory=duck_db_memory,
#                      ETL_Proc_Name=ETL_Proc_Name,
#                      methodName="Insert Into APSTMP_TR_TYPE25",
#                      sql=sql,
#                      current_time=current_time,
#                      update_table="APSTMP_TR_TYPE25")
#
#     sql = """
#      INSERT  /*+ append */  INTO APS_TR_TYPE25 ( GUID, TOOLG_ID, TOOL_ID, PPID, PROCESS_START, PROCESS_END, QTY )
#      SELECT GUID, TOOLG_ID, TOOL_ID, PPID, PROCESS_START, PROCESS_END, QTY
#      FROM APSTMP_TR_TYPE25 T
#      -- WHERE
#      -- NOT EXISTS (
#      --    SELECT TOOL_ID  FROM APS_TR_TYPE25 T25 WHERE T25.PPID = T.PPID
#      --    AND T25.TOOL_ID= T.TOOL_ID AND T25.TOOLG_ID = T.TOOLG_ID
#      --    AND T25.PROCESS_START = T.PROCESS_START
#      --    AND T25.PROCESS_END = T.PROCESS_END AND T25.QTY = T.QTY
#      -- )
#     """
#
#     my_duck.exec_sql(oracle_conn=oracle_conn,
#                      duck_db_memory=duck_db_memory,
#                      ETL_Proc_Name=ETL_Proc_Name,
#                      methodName="Insert Into APS_TR_TYPE25",
#                      sql=sql,
#                      current_time=current_time,
#                      update_table="APS_TR_TYPE25")
#
#
# def execute():
#     ###############################################################
...
#     ###############################################################
#     ETL_Proc_Name = "APS_TR_BR.APS_TR_TYPE25_30M"
#     current_time = my_date.date_time_second_str()
#     current_time_short = my_date.date_time_second_short_str()
#     uuid = my_oracle.UUID()
#
#     target_table = "APS_TR_TYPE25"
#     used_table_list = ['APS_SYNC_ETL_TOOL', 'APS_MID_FHOPEHS_VIEW']
#     target_table_sql = """
#         create table {}APS_TR_TYPE25
#         (
