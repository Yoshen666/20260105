...
def biz_method_01(duck_db_memory, uuid, current_time, oracle_conn, ETL_Proc_Name):
    ...
    sql = """
    INSERT /*+ append */ INTO APS_MID_TYPE22_RUNTIME_ALL_MORE (              
    ...
    my_duck.exec_sql(oracle_conn=oracle_conn,
                     ...
                     methodName="Insert Into APS_MID_TYPE22_RUNTIME_ALL_MORE",
                     sql=sql,
                     current_time=current_time,
                     update_table="APS_MID_TYPE22_RUNTIME_ALL_MORE")
...
def execute():
    ...
    ###############################################################
    ETL_Proc_Name = "APS_ETL_BR.APS_MID_TYPE_RUNTIME_1D_APS_MID_TYPE22_RUNTIME_ALL_MORE"
    current_time = my_date.date_time_second_str()
    current_time_short = my_date.date_time_second_short_str()
    uuid = my_oracle.UUID()

    target_table = "APS_MID_TYPE22_RUNTIME_ALL_MORE"
    used_table_list = ['APS_TR_TYPE22']
    target_table_sql = """
    create table {}APS_MID_TYPE22_RUNTIME_ALL_MORE
    (
      parentid             VARCHAR(64),
