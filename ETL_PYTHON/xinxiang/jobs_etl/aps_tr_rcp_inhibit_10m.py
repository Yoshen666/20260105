...
#     sql = """
#     INSERT  /*+ append */  INTO APS_TR_RCP_INHIBIT (
#        PRODUCT_ID, EQP_ID, RECIPE_ID, REASON_CODE,SUB_LOT_TYPE, GUID, PARTKEY
#     )
#     SELECT PRODUCT_ID, EQP_ID, RECIPE_ID, REASON_CODE,SUB_LOT_TYPE, gen_random_uuid() AS GUID,
#     -- TO_DATE( '"+nowD+"', 'YYYY-MM-DD HH24:MI:SS') AS PARTKEY
#     '{current_time}' AS PARTKEY
#     FROM APS_SYNC_EQP_RCP_INHIBIT.APS_SYNC_EQP_RCP_INHIBIT
#     """.format(current_time=current_time)
#     my_duck.exec_sql(oracle_conn=oracle_conn,
#                      duck_db_memory=duck_db_memory,
#                      ETL_Proc_Name=ETL_Proc_Name,
#                      methodName="Insert Into APS_TR_RCP_INHIBIT",
#                      sql=sql,
#                      current_time=current_time,
#                      update_table="APS_TR_RCP_INHIBIT")
#
#
# def execute():
#     ###############################################################
...
#     ###############################################################
#     ETL_Proc_Name = "APS_ETL_BR.APS_TR_RCP_INHIBIT_10M"
#     current_time = my_date.date_time_second_str()
#     current_time_short = my_date.date_time_second_short_str()
#     uuid = my_oracle.UUID()
#
#     target_table = "APS_TR_RCP_INHIBIT"
#     used_table_list = ['APS_SYNC_EQP_RCP_INHIBIT']
#     target_table_sql = """
#         create table APS_TR_RCP_INHIBIT
#         (
#           product_id   VARCHAR(60),
#           eqp_id       VARCHAR(60),
#           recipe_id    VARCHAR(60),
#           reason_code  VARCHAR(60),
#           sub_lot_type VARCHAR(60),
...
#         # 写警告日志
#         my_oracle.SaveAlarmLogData(oracle_conn, ETL_Proc_Name, e, target_db_file, cons_error_code.APS_TR_RCP_INHIBIT_XX_ETL)
