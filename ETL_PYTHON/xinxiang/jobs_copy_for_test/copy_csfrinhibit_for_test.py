...
def execute():
    ...
    ETL_Proc_Name ="COPY_CSFRINHIBIT_FOR_TEST"
    try:
        # 每小时6min执行
        ...
        if not my_runner.judge_main_server(oracle_conn):
            ...
            backup_folder = "\\\{test_ip}\workspace\ArchiveFile".format(test_ip=config.test_ip)
        ...
        logging.info("COPY_CSFRINHIBIT_FOR_TEST 异常：" + str(copyException))
