...
def execute():
    ...
    ETL_Proc_Name = "COPY_ETL_FOR_BACKUP_123"
    try:
        ...
        etl_backup_folder = "\\\\10.52.192.123\workspace\ETLOutput"
        sync_backup_folder = "\\\\10.52.192.123\workspace\SrcData"

        all_data = my_oracle.get_all_copy_file(oracle_conn)
        ...
        logging.error("COPY_ETL_FOR_BACKUP_123 异常："+ str(copyException))
        my_oracle.SaveAlarmLogData(conn=oracle_conn, ETLProcName="ETLProcCopyBackUpTo123", Exception=copyException, file_name=None,
