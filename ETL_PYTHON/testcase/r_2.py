...
def InsertEQPRecipeReticle2Temp(duck_db_memory=None, uuid="", current_time="", oracle_conn=None, ETL_Proc_Name="",
    ...
    sql = """
     ...
     LEFT JOIN APS_SYNC_DIFF_BATCH_SIZE_MIX.APS_SYNC_DIFF_BATCH_SIZE_MIX VDB ON  W.EQP_ID = VDB.EQP_ID AND W.TARGET_OPE_NO = VDB.OPE_NO 
                              AND W.LCRECIPE_ID = VDB.LOGICAL_RECIPE AND W.M_RECIPE = VDB.M_RECIPE    
...
def getLotSpecialInhibit(duck_db_memory=None, uuid="", current_time="", oracle_conn=None, ETL_Proc_Name="",
    ...
    BATCH_NAME,CASSETE_ID,BATCH_ID,EQP_CHAMBER_FLAG,SUB_LOT_TYPE,MODULE,LOT_PROC_STATE,TRANS_STATE,NO_CH_SET
     ...
     SELECT W.PARENT_ID                                                                                                                                                                  
          ...
          ,W.RETICLE_ID                                                                                         
          ,W.FLOW_RECIPE                                                                                                                                                            
          ,CASE WHEN LS.LOT_ID IS NOT NULL AND LS.LOT_ID <> '' AND TRIM(LS.EQP_ID) <> TRIM(W.EQP_ID) THEN 'LotSpecial;' END AS SET_STATUS6                                                              
     ...
     FROM  {tempdb}APS_TMP_ETL_RLS_EQPRCPRTC_RESULT  W                                                                                                                                                
     LEFT JOIN {tempdb}APS_TMP_ETL_RLS_LOTSPECIAL_RESULT LS ON  LS.LOT_ID = W.LOT_ID  AND LS.OPE_NO = W.TARGET_OPE_NO
...
def getRcpInhibit(duck_db_memory=None, uuid="", current_time="", oracle_conn=None, ETL_Proc_Name="",
    ...
    import pandas as pd
    pg_exist_result = pd.read_sql(sql, duck_db_memory)
    end_time = time.time()
    ...
    sql = """
        INSERT INTO {tempdb}APS_TMP_ETL_RLS_PH_RTD_QTIME(                                                                         
            ...
            -- 针对黄光区加的新版RTDQtime的逻辑
             LEFT JOIN APS_ETL_PH_RTDQTIME.APS_ETL_PH_RTDQTIME AEPR ON AEPR.PLAN_ID = W.TARGET_PLAN_ID 
...
def InsertRlsTempData2Temp(duck_db_memory=None, uuid="", current_time="", oracle_conn=None, ETL_Proc_Name="",
                           used_table_dict=None, pd_result=None):
    sql = """
     ...
     (
      ...
      WITH RLS_DATA AS (
            SELECT W.PARENT_ID                                                                                                                                                                   
              ...
              ,CASE WHEN  RCT.OPE_NO IS NOT NULL AND RCT.OPE_NO <> '' AND RCT.EQP_ID <> W.EQP_ID  THEN 'ReworkComingInhibit;'                                                                                 
              ELSE (CASE WHEN RCST.OPE_NO IS NOT NULL AND RCST.OPE_NO <> '' AND RCST.EQP_ID <> W.EQP_ID  THEN 'ReworkComingInhibit;' END)                                                                      
              END AS SET_STATUS11      
             --如果是RUN状态，则不需要考量 
              ,W.SET_STATUS12      
        ...
        LEFT JOIN {tempdb}APS_TMP_ETL_RLS_REWORK_COMING RCT ON  RCT.OPE_NO = W.TARGET_OPE_NO AND RCT.LOT_SON = W.LOT_ID AND STARTS_WITH(W.TARGET_PLAN_ID,'YY') AND W.OPE_NO <> W.TARGET_OPE_NO
        LEFT JOIN {tempdb}APS_TMP_ETL_RLS_REWORK_COMING_SELF RCST ON  RCST.OPE_NO = W.TARGET_OPE_NO AND RCST.LOT_SON = W.LOT_ID AND STARTS_WITH(W.TARGET_PLAN_ID,'YY') AND W.OPE_NO <> W.TARGET_OPE_NO  
...
def InsertRlsTempByEqpgTemp(duck_db_memory=None, uuid="", current_time="", oracle_conn=None, ETL_Proc_Name="",
    ...
    INSERT INTO {tempdb}APS_TMP_ETL_RLS_EQPG (                        
          PARENT_ID, LOT_ID, STEP_ID, OPE_NO, TARGET_STEP_ID, TARGET_OPE_NO, PLAN_ID, TARGET_PLAN_ID, PROD_ID, PD_ID,
          TARGET_TOOLG_ID, EQP_ID, QTY, M_RECIPE, PHYSICAL_RECIPE_ID, PHOTO_FLAG, RETICLE_ID, ACTIVE_RTCL, CHAMBER_SET,
          SET_STATUS, BATCH_SIZE_MAX, BATCH_SIZE_MIN, FLOW_RECIPE,OTHER_MIN_BATCH_SIZE, NON_WET_BATCH, MODULE,CH_CNT, BATCH_EQP_FLAG
    )                                                                          
     SELECT                                                                                                                                                                                         
           R.PARENT_ID                                                                                                                                                                              
           ,R.LOT_ID                                                                                                                                                                                
...
def RlsTrDataSQL(duck_db_memory=None, uuid="", current_time="", oracle_conn=None, ETL_Proc_Name="",
    ...
    INSERT /*+ append */ INTO   {tempdb}APS_TMP_ETL_RLS_TR_RESULT            
     ( PARENT_ID, LOT_ID, STEP_ID, OPE_NO, TARGET_STEP_ID, TARGET_OPE_NO, PLAN_ID, TARGET_PLAN_ID, TARGET_TOOLG_ID,
       ...
       NPT, PT, OTHER_MIN_BATCH_SIZE, NON_WET_BATCH, MODULE,CH_CNT, BATCH_EQP_FLAG
      )                                                                                                                                         
     SELECT                                                                                                                                                         
            R.PARENT_ID                                                                                                                                             
           ,R.LOT_ID                                                                                                                                                
           ...
           ,R.BATCH_SIZE_MAX                                                                                                                                        
           ,R.BATCH_SIZE_MIN                                                                                                                                        
           ,CASE WHEN (TRCT.TOOL_ID IS NOT NULL AND TRCT.TOOL_ID <> '') THEN TRCT.CHARGE_TIME ELSE ( CASE WHEN R.PHOTO_FLAG = 'Y' THEN                                                                                                                       
           ...
           ,CASE WHEN (TR22.TOOLG_ID IS NOT NULL AND TR22.TOOLG_ID <> '') AND R.BATCH_EQP_FLAG='Y' THEN COALESCE(TR21.PT,TR22.PT) ELSE (CASE WHEN (TR221.TOOLG_ID IS NOT NULL AND TR221.TOOLG_ID<> '') AND R.BATCH_EQP_FLAG='Y' THEN TR221.PT ELSE (CASE WHEN R.PHOTO_FLAG = 'Y' THEN   
                 CASE WHEN ((T21.TOOLG_ID || T21.TOOL_ID || T21.PPID) IS NOT NULL AND (T21.TOOLG_ID || T21.TOOL_ID || T21.PPID) <> '') THEN                                                                               
                           CASE WHEN T21.LESSTHAN20_FLAG = 'Y' THEN                                                                                                 
                                     CASE WHEN (T22.TOOLG_ID || T22.PPID) IS NULL OR T22.LESSTHAN20_FLAG = 'Y' THEN                                                 
                                               CASE WHEN (T221.TOOLG_ID || T221.TOOL_ID) IS NULL THEN 0                                                             
            ...
            ELSE 0                                                                                                                                                  
            END) END) END AS PT                                                                                                                                     
           ,R.OTHER_MIN_BATCH_SIZE,R.NON_WET_BATCH,R.MODULE, R.CH_CNT, R.BATCH_EQP_FLAG                                                                                                                                 
     ...
     --modify by xiecheng for version up
     LEFT JOIN APS_TMP_TYPE21_MEDIAN.APS_TMP_TYPE21_MEDIAN TR21 ON  R.TARGET_TOOLG_ID = TR21.TOOLG_ID AND R.EQP_ID = TR21.TOOL_ID AND R.PHYSICAL_RECIPE_ID = TR21.PPID                  
     LEFT JOIN APS_TMP_TYPE22_MEDIAN.APS_TMP_TYPE22_MEDIAN TR22 ON  R.TARGET_TOOLG_ID = TR22.TOOLG_ID AND R.PHYSICAL_RECIPE_ID = TR22.PPID                                              
     LEFT JOIN APS_TMP_TYPE221_MEDIAN.APS_TMP_TYPE221_MEDIAN TR221 ON  R.TARGET_TOOLG_ID = TR221.TOOLG_ID AND R.EQP_ID = TR221.TOOL_ID                                                   
...
def RlsTrGlobalDataSQL(duck_db_memory=None, uuid="", current_time="", oracle_conn=None, ETL_Proc_Name="",
    ...
    sql = """
     ...
     SELECT                                                                                                                                                       
           ...
           ,R.NPT                                                                                                                                                 
           ---wet 非Batch的要用Global
           ,CASE WHEN R.PT > 0 OR R.BATCH_EQP_FLAG='Y' THEN R.PT  ELSE
     ...
     INSERT /*+ append */ INTO  APS_ETL_RLS                                                                                                                  
       ...
       QTY, MAX_BATCH_SIZE, MIN_BATCH_SIZE, NON_PROCESS_RUNTIME, PROCESS_RUNTIME, UPDATE_TIME,
        ...
        -- recipe_setup 优先顺序V_RTD_RECIPEGROUP >V_RTD_IMP_SOURCE>V_NPW_RECIPE_GROUP>V_RDS_RECIPEINFO
         ...
         LEFT JOIN {tempdb}APS_TMP_ETL_RLS_NPW_RECIPE_GROUP NRG ON NRG.TOOL_ID = R.EQP_ID AND NRG.RECIPE_ID = R.PPID                                                                             
...
def getQtimeGradeData(duck_db_memory=None, uuid="", current_time="", oracle_conn=None, ETL_Proc_Name="",
    ...
    sql = """
        INSERT INTO {tempdb}APS_TMP_ETL_RLS_QTIME_GRADE(                              
            PLAN_ID, TRIGGER_OPE_NO, TARGET_OPE_NO                                                           
        )                                                                          
         WITH GARDE_DATA AS (                                                                                                                                                                                                              
          SELECT A.CUSTOM_FIELD,A.TRIGGER_MAINPD_ID,A.TRIGGER_OPE_NO,A.TARGET_MAINPD_ID,A.TARGET_OPE_NO,                                                      
             ROW_NUMBER() OVER(PARTITION BY A.TRIGGER_MAINPD_ID,A.TRIGGER_OPE_NO,A.TARGET_MAINPD_ID,              
                    A.TARGET_OPE_NO ORDER BY A.CUSTOM_FIELD) AS RNT                                               
          FROM APS_SYNC_FRQTIME_ACTION.APS_SYNC_FRQTIME_ACTION A                                                                                                                                       
         )                                                                                                                                                       
         SELECT TRIGGER_MAINPD_ID,TRIGGER_OPE_NO,TARGET_OPE_NO                                                                     
         FROM GARDE_DATA                                                                                                                                         
         WHERE RNT = 1 AND TRIGGER_MAINPD_ID = TARGET_MAINPD_ID                                                   
    ...
    sql = """
         ...
         SELECT DISTINCT G.PLAN_ID,                                                                                                                                                                  
                ...
                OVER(PARTITION BY F.PROD_ID, F.PLAN_ID, G.TRIGGER_OPE_NO, G.TARGET_OPE_NO ORDER BY F.STEP_ID ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING) TRIGGER_STEP_ID,     
                LAST_VALUE(F.STEP_ID IGNORE NULLS)                                                                                                                                          
                OVER(PARTITION BY F.PROD_ID, F.PLAN_ID, G.TRIGGER_OPE_NO, G.TARGET_OPE_NO ORDER BY F.STEP_ID ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING) TARGET_STEP_ID       
         FROM {tempdb}APS_TMP_ETL_RLS_QTIME_GRADE G                                                                                                                                                 
         INNER JOIN APS_ETL_FLOW.APS_ETL_FLOW F                                                                                                                                                          
         ON F.PLAN_ID = G.PLAN_ID                                                                                                                                                                                                                                                                                                                       
         AND (CASE WHEN F.OPE_NO = G.TRIGGER_OPE_NO THEN 1                                                                                                                                  
         WHEN F.OPE_NO = G.TARGET_OPE_NO THEN 1                                                                                                                                             
           ELSE 0 END = 1)        
          """.format(tempdb=my_duck.get_temp_table_mark())
    my_duck.exec_sql(oracle_conn=oracle_conn,
                     duck_db_memory=duck_db_memory,
