...
#     sql = """
#     INSERT  /*+ append */  INTO APS_TR_TYPE33 (
#       GUID, MODULE_ID, TOOLG_ID, PROCESS_START, PROCESS_END, PARTKEY
#     )
#      WITH TOOL AS (
...
#      AND SP.END_TIME BETWEEN DATE_TRUNC('day', CURRENT_DATE) - INTERVAL '30 day'
...
#                      methodName="Insert Into APS_TR_TYPE33",
#                      sql=sql,
#                      current_time=current_time,
#                      update_table="APS_TR_TYPE33")
#
#
# def execute():
#     ###############################################################
...
#     ###############################################################
#     ETL_Proc_Name = "APS_TR_BR.APS_TR_TYPE33_5M"
#     current_time = my_date.date_time_second_str()
#     current_time_short = my_date.date_time_second_short_str();
#     uuid = my_oracle.UUID()
#
#     target_table = "APS_TR_TYPE33"
#     used_table_list = ['APS_SYNC_ETL_TOOL', 'APS_SYNC_IDLE_DUMMY_SPEC']
#     target_table_sql = """
#         create table {}APS_TR_TYPE33
#         (
