from xinxiang.jobs_etl import aps_tmp_lothistory_5m_APS_MID_PH_LOTHISTORY, aps_tr_type11_30m, aps_tr_type12_30m, \
    ...
    aps_etl_special_cons_10m, aps_tmp_type21_median_1d_APS_MID_PURGE11, \
...
from xinxiang.jobs_etl import everyday_generate_log_file


def set_etl_cron(schedule):
    schedule.add_job(everyday_generate_log_file.execute, 'cron', hour='0', misfire_grace_time=60)  # 周期从10点开始,每天执行一次
